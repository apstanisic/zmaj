import { Select } from "@admin-panel/ui/Select"
import { ToggleButton } from "@admin-panel/ui/ToggleButton"
import { useAvailableStorageProviders } from "../hooks/use-available-storage-providers"
...
export function StorageProvidersDropdown(): JSX.Element {
	...
	const providers = useAvailableStorageProviders().data
