...
import { DbColumn } from "./db-column.type"
import { ForeignKey } from "./foreign-key.type"
...
export abstract class SchemaInfoService {
	...
	abstract getCompositeUniqueKeys(options?: TableOnlyParams): Promise<CompositeUnique[]>
