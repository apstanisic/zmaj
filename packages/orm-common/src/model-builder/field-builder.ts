...
export type ExtractFields<T extends Record<string, ParamsAndType<any, any>>> = {
	[key in keyof T]: T[key]["_type"]
}

export type ExtractCreateParams<T extends Record<string, ParamsAndType<any, any>>> = {
	[key in keyof T]: T[key]["_create"]
}

export type ExtractUpdateParams<T extends Record<string, ParamsAndType<any, any>>> = {
